...
def setup_logger(name: str,
    ...
    Args:
        ...
        log_path (str): The directory path to store the log file. Defaults to
            None. If set to True the default path will be used.
        console_output (bool): If logs should be printed to the console.
            Defaults to True.
