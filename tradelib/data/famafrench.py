...
class FamaFrench(DataService):
    ...
    def _download_and_prepare_data(self) -> None:
        ...
        try:
            ...
            urllib.request.urlretrieve(
                ff_url, f'{self._temp_dir}/fama_french.zip')
        ...
        try:
            ...
            os.remove(
                f'{self._temp_dir}/F-F_Research_Data_Factors_daily.CSV')
    ...
    def download(
        ...
        """Downloads the Fama & French data from the web."""
        return self.famafrench_data_historic(start, stop, update)
